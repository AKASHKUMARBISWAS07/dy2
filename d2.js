...
ans:
when ever we run a js code the creation phaseis been created and declaratons are stored in it. 
The execution phase is the next phase after finishing the creation phase.
An execution phase is the one where the JS engines scan through the function in the code 
